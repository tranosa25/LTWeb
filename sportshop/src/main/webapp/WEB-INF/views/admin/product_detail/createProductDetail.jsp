				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading"
							...
							<h3 class="panel-title">CREATE PRODUCT DETAIL</h3>
						...
						<form action="productdetail-create" method="post" enctype="multipart/form-data">
							<div class="row"
								style="display: flex; justify-content: space-between;">
									...
									<tr>
										...
										<td><select name="productId">
												<c:forEach items="${product}" var="products">
													<option value="${products.getProductId()}">${products.getProductName()}</option>
												</c:forEach>
										</select></td>
									</tr>
									<tr>
										...
										<td><select name="colorId">
												<c:forEach items="${color}" var="colors">
													<option value="${colors.getColorId()}">${colors.getColor()}</option>
												</c:forEach>
										</select></td>
									</tr>
									<tr>
										...
										<td><select name="sizeId">
												<c:forEach items="${size}" var="sizes">
													<option value="${sizes.getSizeId()}">${sizes.getSize()}</option>
												</c:forEach>
										</select></td>
									</tr>
									<tr>
